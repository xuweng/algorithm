 ...
 * 优秀代码。
 * 简洁代码。
 * 优秀代码。简洁代码。简洁代码。简洁代码。简洁代码。优秀代码。优秀代码。优秀代码。优秀代码。
 * 简洁代码。简洁代码。简洁代码。简洁代码。简洁代码。优秀代码。
 * <p>
...
public class MatrixUDG {
    ...
    private void DFS(int i, boolean[] visited) {
        ...
        for (int w = firstVertex(i); w >= 0 && !visited[w]; w = nextVertex(i, w)) {
            DFS(w, visited);
        }
    }
    ...
    public void DFS() {
        ...
        //遍历所有结点。包括没有连通的结点。保证每个结点都能访问。
        for (int i = 0; i < mVexs.length && !visited[i]; i++) {
            DFS(i, visited);
        }
        System.out.printf("\n");
    }
